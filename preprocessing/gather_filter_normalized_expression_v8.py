...
tissueNamesFile = dir + 'gtex_v8_tissues_all_normalized_samples.txt'
individualsFile = dir + 'gtex_v8_individuals_all_normalized_samples.txt'
outfile = dir + 'gtex_v8_normalized_expression.txt'

exprdir = dir + 'PEER_gtex8_wide/' # from Jessica and Nicole
...
for tissue in tissues:
	filename = exprdir + tissue + '.globalOutliers.v8ciseqtls.removed.outlierGenes.zscores.txt'
