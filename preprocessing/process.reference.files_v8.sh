...
gencodeprefix=${RAREVARDIR}/reference/gencode.v26.annotation
gtexprefix=${RAREVARDIR}/reference/gencode.v26.genes.v8.patched_contigs
...
~/.conda/envs/RAREVAR/bin/python pad.gtf.exons.py $gencode | sort -k1,1 -k2,2n | uniq > ${gencodeprefix}_coding.lincRNA_padded.bed
