...
plot_watershed_GAM <- function(evaOutput, top_title=NULL){
...
plot_watershed_GAM(eval_euro_all, top_title="European All Features")
...
plot_watershed_GAM(eval_euro_common, top_title="European Common Features")

eval_afr_all <- readRDS("/scratch/groups/abattle4/victor/GTExV8_RareVariationData/RIVER/eval_afr_all_evaluation_object.rds")
plot_watershed_GAM(eval_afr_all, top_title="African All Features")
...
plot_watershed_GAM(eval_afr_common, top_title="African Common Features")
```
