...
```
```{r wilcoxon, cache=TRUE, eval=FALSE}

for_wrs <- rbind(euro_posterior, afr_posterior) %>% gather(key=key,value=value,-indiv,-ethnicity) %>%
  filter(key=="count_0.5")

wilcox.test(for_wrs$value[for_wrs$ethnicity == "European"],for_wrs$value[for_wrs$ethnicity == "African American"])
```
...
Rscript ${watershed_dir}/evaluate_watershed.R --input $euro_all --number_dimensions 1 --output_prefix "eval_euro_all" --model_name RIVER --dirichlet_prior_parameter 30 --l2_prior_parameter .001 --n2_pair_pvalue_fraction .01 --binary_pvalue_threshold .01

# European common features
euro_common="/scratch/groups/abattle4/victor/GTExV8_RareVariationData/RIVER/river_input_v8_european_common_06-09-2020.txt"
Rscript ${watershed_dir}/evaluate_watershed.R --input $euro_common --number_dimensions 1 --output_prefix eval_euro_common --model_name RIVER --dirichlet_prior_parameter 30 --l2_prior_parameter .001 --n2_pair_pvalue_fraction .01 --binary_pvalue_threshold .01

# African all features
afr_all="/scratch/groups/abattle4/victor/GTExV8_RareVariationData/RIVER/river_input_v8_african_all_06-09-2020.txt.txt"
Rscript ${watershed_dir}/evaluate_watershed.R --input $afr_all --number_dimensions 1 --output_prefix eval_afr_all --model_name RIVER --dirichlet_prior_parameter 30 --l2_prior_parameter .001 --n2_pair_pvalue_fraction .01 --binary_pvalue_threshold .01

# African common features
afr_common="/scratch/groups/abattle4/victor/GTExV8_RareVariationData/RIVER/river_input_v8_african_common_06-09-2020.txt"
Rscript ${watershed_dir}/evaluate_watershed.R --input $afr_common --number_dimensions 1 --output_prefix eval_afr_common --model_name RIVER --dirichlet_prior_parameter 30 --l2_prior_parameter .001 --n2_pair_pvalue_fraction .01 --binary_pvalue_threshold .01
