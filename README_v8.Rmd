...
bash preprocessing/long_to_wide_exprbytissue.sh
```

### Make list of individuals and tissues from GTEx
Make list of all individuals from GTEx v8 that have WGS data
```{bash }
