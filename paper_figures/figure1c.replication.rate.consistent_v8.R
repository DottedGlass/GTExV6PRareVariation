...
# Load data generated by call_outliers/multi_tissue_replication_v8.R
load(paste0(dir, '/data/figure1c.replication.rate.consistent_v8.RData'))
...
pdf(paste0(dir, '/paper_figures/figure1c.replication.rate.consistent_v8.pdf'), width = 4.3, height = 2.8)
