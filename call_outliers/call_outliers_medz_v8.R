...
data = fread(paste0(dir,'/preprocessing/gtex_v8_normalized_expression.txt'), header = T)
...
wgs.feat.inds = read.table('../preprocessing/gtex_v8_wgs_individuals.txt', sep = '\t', header = F, stringsAsFactors = F)[, 1]
